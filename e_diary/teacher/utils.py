...
def get_timetable(day_date, user):
    ...
    lessons_and_time = [
        {'number': 1, 'time': '09:00-09:45', 'title': 'нет урока', 'class': '-', 'homework': '', 'comment': '', 'id': ''},
        {'number': 2, 'time': '10:00-10:45', 'title': 'нет урока', 'class': '-', 'homework': '', 'comment': '', 'id': ''},
        {'number': 3, 'time': '11:00-11:45', 'title': 'нет урока', 'class': '-', 'homework': '', 'comment': '', 'id': ''},
        {'number': 4, 'time': '12:00-12:45', 'title': 'нет урока', 'class': '-', 'homework': '', 'comment': '', 'id': ''},
        {'number': 5, 'time': '13:00-13:45', 'title': 'нет урока', 'class': '-', 'homework': '', 'comment': '', 'id': ''},
        {'number': 6, 'time': '14:00-14:45', 'title': 'нет урока', 'class': '-', 'homework': '', 'comment': '', 'id': ''},
        {'number': 7, 'time': '15:00-15:45', 'title': 'нет урока', 'class': '-', 'homework': '', 'comment': '', 'id': ''}
        ]
